<?php
    ...
    'email, export_stream, manage_notifications, offline_access, photo_upload, publish_actions,'.
    'publish_stream, read_mailbox, read_requests, read_stream, share_item, status_update';
